...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func applicationWillResignActive(_ application: UIApplication) {
        ...
        if self.house.gameClock.isPaused == false{
            self.house.gameClock.pauseResume()
        }
    ...
    func applicationDidBecomeActive(_ application: UIApplication) {
        ...
        if self.house.gameClock.isPaused {
            self.house.gameClock.pauseResume()
        }
    }
    ...
    lazy var applicationDocumentsDirectory: URL = {
        // The directory the application uses to store the Core Data store file. This code uses a directory named "com.terry-torres.horrible_house" in the application's documents Application Support directory.
    ...
    lazy var managedObjectModel: NSManagedObjectModel = {
        ...
        let modelURL = Bundle.main.url(forResource: "horrible_house", withExtension: "momd")!
